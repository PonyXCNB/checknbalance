...
const FEATURED_ABBRS = ["AL", "FL", "NY", "DC", "NJ"];
const CONTROL_ABBRS = ["TX", "CA"];
const { check, summary } = makeChecker();

// --- index.html and the fully built state pages: run every inline script once ---
for (const page of ["index.html", "nc.html", "sc.html", "ga.html", "va.html", "md.html", "de.html"]) {
...
for (const [abbr, page] of [["NC", "nc.html"], ["SC", "sc.html"], ["GA", "ga.html"], ["VA", "va.html"], ["MD", "md.html"], ["DE", "de.html"]]) {
