...
## MAP / PROP A GATE - WAVE 49 UPDATE (September 11, 2026, evening ET)

**STATUS: gate still OPEN for mo.html.** No mo.html started. Currency-test still incomplete (no public Nov CD sample-label table). Parcel notes reconfirmed, not closed. Today is still Sept 11 - Sept 15 briefs / Sept 17 args / UOCAVA Sept 19 have not arrived yet. Skip DE inventing until after Sept 15.

### Court posture (Wave 49 free-web reconfirm)
- **U.S. Supreme Court (Sept 10, 2026):** stay of Judge Clark TRO remains in force - 2022 map governs November for now (Missouri Times / SCOTUSblog). Stay remains pending 8th Cir appeal disposition (+ cert if sought).
- **Missouri Supreme Court (Sept 10):** Hoskins contempt purged after directing LEAs back to the **2022 map** (Missouri Times).
- **8th Circuit:** expedited appeal calendar still lists simultaneous briefs **Sept 15** and remote oral arguments **Sept 17, 10 a.m.** (Missouri Times Wave 49 live reconfirm; case Onder v. State of Missouri, No. 26-2797). No public posting of those briefs located Wave 49 - they are not due yet (today still Sept 11).
- **UOCAVA:** military/overseas ballots must transmit by **Sept 19** (Votebeat / prior notes). Gate watch remains live through UOCAVA and ballot-print deadlines.
- **Prop A / referendum** on HB 1 remains on the November ballot (Ballotpedia / Missouri Times).

### Currency-test (still NOT closed)
- **Cole County:** colecounty.org/441/Sample-Ballots **still** only links **August 4, 2026 Combined Sample Ballot** (Wave 49 live fetch; page text has August only - no November/General sample link).
- **Boone / Jackson / STL:** no new public countywide Nov CD-label PDF matched to mo-cd120.json this pass.
- **Still no public statewide (or even single-county public-PDF) November sample-ballot district-label table matched to `mo-cd120.json`.**
...
### Sources / locks added this wave
1. colecounty.org/441/Sample-Ballots - still August Combined Sample only (Wave 49 live fetch).
2. themissouritimes.com/supreme-court-passes-on-new-congressional-map/ - SCOTUS stay + 8th Cir briefs Sept 15 / args Sept 17 calendar reconfirm; briefs not yet public.
3. **OK Perry:** Guardian org hunt Wave 49 still unmatched (false positives Lauren Perry / Perry OK city only); Pre-General window Oct 20-26; Ballotpedia finance blank.
4. **Parrott FEC:** weball26 bulk has NO H6FL06316 / Andrew Parrott row (Neil Parrott MD-06 only); site still Ready to serve you; $0 absence stands.
5. Lock rechecks Wave 49: katecotten.com still Launching Soon HTTP 200; rozforalabama.com/issues still 404; yoshimatthews.com unpaid-invoice + /issues 404; azgp.org / mikecease.com ENOTFOUND; Lund/Koehn still no personal office platforms (LPKS slate only; rickoehn.com personal). NM CFIS: login.cfis.sos.state.nm.us HTTP 200; www.cfis.state.nm.us/media CandidateMain year dropdown still tops at 2020; cfis.sos.nm.gov DNS ENOTFOUND; First General filings due Sept 14 - not yet.


## MAP / PROP A GATE - WAVE 50 UPDATE (September 11, 2026, evening ET)
...
### Court posture (Wave 50 free-web reconfirm)
- **U.S. Supreme Court (Sept 10, 2026):** stay of Judge Clark TRO remains in force - 2022 map governs November for now (Missouri Times). Stay remains pending 8th Cir appeal disposition (+ cert if sought).
- **8th Circuit (Onder v. Missouri, No. 26-2797):** expedited calendar still lists simultaneous briefs **Sept 15** and remote oral arguments **Sept 17, 10 a.m.** (Missouri Times Wave 50 reconfirm). No public posting of those briefs located Wave 50 - they are not due yet (today still Sept 11).
...
### Currency-test (still NOT closed)
- **Cole County:** colecounty.org/441/Sample-Ballots **still** only links **August 4, 2026 Combined Sample Ballot** (Wave 50 live fetch; page text has August only - no November/General sample link).
- **Boone / Jackson / STL:** no new public countywide Nov CD-label PDF matched to mo-cd120.json this pass.
- **Still no public statewide (or even single-county public-PDF) November sample-ballot district-label table matched to `mo-cd120.json`.**
...
### Sources / locks added this wave
1. colecounty.org/441/Sample-Ballots - still August Combined Sample only (Wave 50 live fetch).
2. themissouritimes.com/supreme-court-passes-on-new-congressional-map/ - SCOTUS stay + 8th Cir briefs Sept 15 / args Sept 17 calendar reconfirm; briefs not yet public.
3. **AZ Swing ballot unlock:** FOX 10 Phoenix Sept 10, 2026 Clean Elections CD-6 coverage lists Gary Swing among five Nov 3 candidates and quotes his SoS nomination-paper statement - clears prior Facebook-only certifiability uncertainty.
4. **Kobach crime claim:** KBI July 6, 2026 Crime Index bulletin independently confirms 2025 crime index rate lowest in 57 years; $320M restitution remains campaign self-claim.
5. **Lloyd endorsements:** votedouglloyd.com/sheriff-endorsements static named sheriff list (Wave 50); clears prior JS-only extract lock.
6. **OK Perry:** Guardian org hunt Wave 50 still unmatched; Pre-General window Oct 20-26; Ballotpedia finance blank.
7. Lock rechecks Wave 50: katecotten.com TLS fail this pass (prior Launching Soon); rozforalabama.com/issues still 404; yoshimatthews.com unpaid-invoice + /issues 404; azgp.org / mikecease.com unreachable; Lund LPKS-only; Koehn rickoehn.com TLS error; Parrott site live + $0. NM CFIS: login.cfis.sos.state.nm.us HTTP 200; www.cfis.state.nm.us/media up; cfis.sos.nm.gov DNS ENOTFOUND; First General due Sept 14 - still pre-deadline today Sept 11.


## MAP / PROP A GATE - WAVE 51 UPDATE (September 11, 2026, late evening ET)

**STATUS: gate still OPEN for mo.html.** No mo.html started. Currency-test still incomplete (no public Nov CD sample-label table). Today is still Sept 11 - Sept 15 briefs / Sept 17 args / UOCAVA Sept 19 have not arrived yet. Skip DE inventing until after Sept 15.

### Court posture (Wave 51 free-web reconfirm)
- **U.S. Supreme Court:** stay of Judge Clark TRO remains in force - 2022 map governs November for now (continuity from Wave 50 Missouri Times reporting; no Wave 51 contrary ruling located).
- **8th Circuit (Onder v. Missouri):** expedited calendar still lists simultaneous briefs **Sept 15** and remote oral arguments **Sept 17, 10 a.m.** Briefs are not due yet (today still Sept 11); no public posting of those briefs located Wave 51.
- **UOCAVA:** military/overseas ballots must transmit by **Sept 19**. Gate watch remains live through UOCAVA and ballot-print deadlines.
- **Prop A / referendum** on HB 1 remains on the November ballot.

### Currency-test (still NOT closed)
- **Cole County:** colecounty.org/441/Sample-Ballots **still** only links **August 4, 2026 Combined Sample Ballot** (Wave 51 live fetch; page text has August only - no November/General sample link).
- **Boone / Jackson / STL:** no new public countywide Nov CD-label PDF matched to mo-cd120.json this pass.
- **Still no public statewide (or even single-county public-PDF) November sample-ballot district-label table matched to `mo-cd120.json`.**
...
### Sources / locks added this wave
1. colecounty.org/441/Sample-Ballots - still August Combined Sample only (Wave 51 live fetch).
2. **MI Kumar unlock:** drkumarforcongress.org authenticated (paid-for-by Dr. Anil Kumar for Congress / FEC H4MI10131); about-page healthcare/education/independent framing; multi-cycle bids 2014/2016/2024/2026 (Ballotpedia/MIRS). Board/regents soft pads SKIPPED (no individual sites).
3. **KS Kobach:** Kansas Reflector Aug 26, 2026 independently reports Kansas $134M Meta share; campaign $320M total still self-claim. Mann LE-callback claim sourced to chrismannforkansas.com/priorities + WIBW/HPPR Sept 2026 (opponent characterization).
...
## MAP / PROP A GATE - WAVE 53 UPDATE (September 11, 2026, evening ET)

**STATUS: gate still OPEN for mo.html.** No mo.html started. Currency-test still incomplete (no public Nov CD sample-label table). Today is still Sept 11 - Sept 15 briefs / Sept 17 args / UOCAVA Sept 19 have not arrived yet. Skip DE inventing until after Sept 15 (Wave 53 only soft-padded one DE absence marker; no invented platform).

### Court posture (Wave 53 free-web reconfirm)
- **U.S. Supreme Court:** stay of Judge Clark TRO remains in force - 2022 map governs November for now (Missouri Times / Democracy Docket continuity; no Wave 53 contrary SCOTUS ruling located).
- **8th Circuit (Onder v. Missouri, No. 26-2797):** expedited calendar still lists simultaneous briefs **Sept 15** and remote oral arguments **Sept 17** (10 a.m.; Onder plaintiffs 10 min / Missouri+Hoskins 10 / Von Glahn+People Not Politicians 20). Briefs are not due yet (today still Sept 11); no public posting of those briefs located Wave 53. 8th Cir Sept 9 order denied stay pending appeal / summary reversal.
- **UOCAVA:** military/overseas ballots must transmit by **Sept 19**. Gate watch remains live through UOCAVA and ballot-print deadlines.
- **Prop A / referendum** on HB 1 remains on the November ballot.

### Currency-test (still NOT closed)
- **Cole County:** colecounty.org/441/Sample-Ballots **still** only links **August 4, 2026 Combined Sample Ballot** (Wave 53 live fetch; page has August link, no November/General sample link).
- **Boone / Jackson / STL:** no new public countywide Nov CD-label PDF matched to mo-cd120.json this pass.
- **Still no public statewide (or even single-county public-PDF) November sample-ballot district-label table matched to `mo-cd120.json`.**
...
### Sources / locks added this wave
1. colecounty.org/441/Sample-Ballots - still August Combined Sample only (Wave 53 live fetch).
2. **IN Ballard unlock:** gregballard.com + IndyStar/WFYI Aug 25 - precinct voters guide (~$2.5M), no side-taking in other races, clerk/poll-worker training (Sept 9 release), nonpartisan Recount Commission of retired judges (Aug 28 release).
3. **IN Bayh:** beaubayh.com/issues redirects to /priorities (Wave 53 live) - same secure/fair + early voting + open primaries + corruption + referendums frame; mail/roll still thin.
